...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background py-12">
      <div className="w-full max-w-md p-8 bg-card border border-border rounded-lg">
        <h1 className="text-2xl font-bold text-foreground mb-6">Create an account</h1>
        
        {error && (
          <div className="mb-4 p-3 bg-error/15 text-error rounded-md text-sm">
            {error}
          </div>
        )}
        ...
        <div className="space-y-4 mb-6">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-foreground text-background rounded-md hover:opacity-90 disabled:opacity-50"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Used in embed URLs: illustrate.md/{username || "username"}/diagram
            </p>
          </div>
