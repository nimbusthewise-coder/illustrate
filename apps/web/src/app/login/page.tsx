...
export default function LoginPage() {
  ...
  const { user, loading, error, signInWithEmail, signInWithOAuth, clearError, initialize, initialized } = useAuthStore();
        ...
        <div className="bg-card border border-border rounded-lg p-6 space-y-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-[#24292e] text-white rounded-lg hover:bg-[#1b1f23] transition-colors"
            >
